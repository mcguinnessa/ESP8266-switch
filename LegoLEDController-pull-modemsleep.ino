...
//  pinMode(BUILTIN_TX_PIN, OUTPUT);
  ...
  /**
   * This basically puts the modem to sleep most of the time the board is in the delay()
   */
  wifi_set_sleep_type(MODEM_SLEEP_T);


  /**
   * Same as model sleep, but disables a lot more stuff
   */
...
void loop() {
   ...
   // Send request
   http.begin(client, "http://192.168.0.124:3000/db5/light/status");
   http.GET();
