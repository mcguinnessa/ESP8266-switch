...
//  for (int i=0; i<50; i++){
//    String req = aClient.readStringUntil('\r');
//
//    for(int j=0; j<req.length(); j++){
//      Serial.print((int)req.charAt(j));
//      Serial.print(" ");      
//    }
//    Serial.println("");      
//
...
//  Serial.println("PUT EP ARRAY");
//  for (int k=0; k<num_seps; k++){
//     Serial.print("   ");
//     Serial.println(ep_commands[k]);
//  }  

//  if(0==strcmp(ADMIN_COMMAND, ep_commands[0])){
//    handleAdminChange(aClient, ep_commands);
//  } else 
...
// */
//void handleAdminChange(WiFiClient& aClient, char** aCommandArray){
//  Serial.print(*aCommandArray);  
//  Serial.println(" is supported");  
//
//  JSONVar json;
//  float vcc = 0;
//  if(0==strcmp(VCC, aCommandArray[1])){
//
...
//  client.flush();
  ...
  //  for (int j=0; j<num_seps; j++){
  //     Serial.print("   ");
  //     Serial.println(components[j]);
  //  }
